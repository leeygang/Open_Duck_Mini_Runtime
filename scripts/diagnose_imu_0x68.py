#!/usr/bin/env python3
"""
Diagnostic script to identify what IMU is at address 0x68 on channel 0.
"""
...
def main():
    print("=" * 60)
    print("IMU Device Identification at 0x68")
    print("=" * 60)

    with SMBus(BUS) as bus:
        # Enable multiplexer channel 0
        print(f"\nEnabling multiplexer channel 0...")
        bus.write_byte(MUX_ADDR, 0x01)

        print(f"Reading WHO_AM_I registers from device at 0x{IMU_ADDR:02X}...\n")
